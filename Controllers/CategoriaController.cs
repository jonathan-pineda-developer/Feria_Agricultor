...
namespace feria.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public CategoriaController(feriaAgricultorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,Nonbre")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,Nonbre")] Categorium categorium)
        {
